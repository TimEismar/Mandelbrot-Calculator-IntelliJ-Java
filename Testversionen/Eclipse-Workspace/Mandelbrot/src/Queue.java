...
public class Queue<ContentType> {
  ...
  /* --------- Anfang der privaten inneren Klasse (nested class) -------------- */
  ...
  /* ----------- Ende der privaten inneren Klasse (nested class) -------------- */

  /*
   * Hier: Implementierung der beiden (globalen) Referenzvariablen auf den KOPF und das ENDE
   * der Warteschlange. Kapseln Sie die beiden Attribute sinnvoll, da sie von anderen Klassen
   * bzw. Instanzen des Projekts aus nicht zugänglich sein sollen.
   */
   ...
   * ContentType sein. Initialisieren Sie die leere Schlange sinnvoll.
   */
  public Queue() {
    // --> ???
    head = null;
   ...
   * sonst liefert sie den Wert false. Überlegen Sie, woran eine leere Schlange
   * erkannt werden kann.
   *
   ...
   * Prüfen Sie vorab, ob das übergebene pContentType-Element ungleich null
   * ist.
   *
   * @param pContent
